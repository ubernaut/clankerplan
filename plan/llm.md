...
keep a conscice high level plan document in plan.md
...
use vite, vanilla js, three.js, webGPU compute pipelines. use three.js extensions or built in options where available. 
